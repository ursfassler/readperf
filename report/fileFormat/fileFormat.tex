...
This section will give a detailed description of the perf file\index{perf file} format. The file format is designed in such a way that it is upwards and downwards compatible. This is very convenient for the users, but makes the file format more complicated and therefore more difficult to understand. Nevertheless, the following description should give enough information to work with the perf data file.
...
\input{fileFormat/header}
\FloatBarrier
\input{fileFormat/data}
\FloatBarrier
